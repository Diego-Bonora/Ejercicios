...
def mostrar_bombilla(lista_bombillas):

    for i in range(len(lista_bombillas)):
        print(lista_bombillas[i].estado)

def interruptor_bombillas(lista_bombillas, llave_termica, prendidas):
...
def apagar_termica(llave_termica, lista_bombillas, prendidas):
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if numero_elejido == 1:
            ...
            mostrar_bombilla(lista_bombillas)
            ...
            interruptor_bombillas(lista_bombillas, llave_termica, prendidas)

        elif numero_elejido == 4:

            apagar_termica(llave_termica, lista_bombillas, prendidas)
